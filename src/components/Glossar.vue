    ...
    return {
      items: [
        ...
        },
        {
          Topic: 'Block Height',
          Deutsch: 'Block Höhe',
          Definition: 'Die Anzahl der an der Blockchain angeschlossenen Blöcke.'
        },
        {
          Topic: 'Block Reward',
          Deutsch: 'Blockprämie',
        ...
        {
          Topic: 'Central Ledger',
          Deutsch: 'Zentraler Ledger',
          Definition: 'Ein Ledger, das von einer zentralen Stelle geführt wird.'
        },
        {
          Topic: 'Confirmation',
          Deutsch: 'Bestätigung',
        ...
        },
        {
          ...
          Deutsch: 'Kryptographische Hash-Funktion',
          Definition:
        ...
        {
          Topic: 'Genesis Block',
          Deutsch: 'Genesis-Block',
          Definition: 'Die ersten oder ersten paar Blöcke einer Blockchain.'
        },
        {
          Topic: 'Hard Fork',
          Deutsch: 'Harte Gabelung',
          Definition:
        ...
        {
          Topic: 'Multi-Signature',
          Deutsch: 'Multi-Signatur',
          Definition:
        ...
        {
          Topic: 'Peer to Peer',
          Deutsch: 'Peer zu Peer',
          Definition:
            'Peer to Peer (P2P) bezeichnet die dezentrale Interaktion zwischen zwei oder mehr Parteien in einem hochvernetzten Netzwerk. Die Teilnehmer eines P2P-Netzwerks handeln direkt miteinander über einen einzigen Mediationspunkt.'
        },
        {
          Topic: 'Public Address',
          Deutsch: 'Öffentliche Adresse',
          Definition:
        ...
        },
        {
          ...
          Deutsch: 'Nachweis des Einsatzes',
          Definition:
        ...
        },
        {
          ...
          Deutsch: 'Turing Complete',
          Definition:
            'Turing Complete bezieht sich auf die Fähigkeit einer Maschine, Berechnungen durchzuführen, zu denen jeder andere programmierbare Computer in der Lage ist. Ein Beispiel dafür ist die Ethereum Virtual Machine (EVM).'
        },
        {
          Topic: 'Wallet',
          Deutsch: 'Brieftasche',
        ...
        {
          Topic: 'BTFD (Buy the fucking dip)',
          Deutsch: '',
          Definition:
        ...
        {
          Topic: 'MCAP (Market capitalisation)',
          Deutsch: '',
          Definition:
        ...
        },
        {
          Topic: 'Pump / Pumping',
          Deutsch: '',
          Definition: 'Jemand, der für eine andere Krypto-Währung wirbt.'
        },
        {
          Topic: 'Rekt',
          Deutsch: '',
        ...
        },
        {
          Topic: 'Whale',
          Deutsch: '',
          Definition: 'Jemand, der absurde Mengen an Krypto-Währung besitzt.'
        },
        {
          Topic: 'Fiat Currency',
          Deutsch: '',
          Definition:
            'Bezieht sich auf Währungen, die selbst einen minimalen oder keinen inneren Wert haben (d.h. sie sind nicht durch Rohstoffe wie Gold oder Silber unterlegt), sondern von der Regierung als gesetzliches Zahlungsmittel definiert sind, wie z.B. Papierrechnungen und Münzen.'
        },
        {
          Topic: 'Limit order / limit buy / limit sell',
          Deutsch: 'Limitauftrag / Limitkauf / Limitverkauf',
          Definition:
        ...
        {
          Topic: 'Sell wall / buy wall',
          Deutsch: 'Wall verkaufen / kaufen',
          Definition:
        ...
        {
          Topic: 'Market order / market buy / market sell',
          Deutsch: 'Marktorder / Marktkauf / Marktverkauf',
          Definition:
        ...
        },
        {
          ...
          Deutsch: 'Margenhandel',
          Definition:
            'Der Akt der Vergrößerung der Intensität Ihrer Geschäfte, indem Sie Ihre vorhandenen Coins riskieren. (HINWEIS: Sehr riskant, nur für erfahrene Händler und nur an bestimmten Börsen möglich)'
        },
        {
          Topic: 'Going long',
          Deutsch: '',
          Definition: 'Ein Margenhandel, der profitiert, wenn der Preis steigt.'
        },
        {
          Topic: 'Going short',
          Deutsch: '',
          Definition: 'Ein Margenhandel, der profitiert, wenn der Preis sinkt.'
        },
        {
          Topic: 'Bullish',
          Deutsch: 'Bullisch',
          Definition: 'Eine Erwartung, dass der Preis steigen wird.'
        },
        {
          Topic: 'Bearish',
          Deutsch: 'Bärisch',
          Definition: 'Eine Erwartung, dass der Preis sinken wird.'
        },
        {
          Topic: 'Altcoin',
          Deutsch: 'Altcoin',
          Definition:
            'Generell jede andere Krypto-Währung als Bitcoin oder Ethereum. (Obwohl einige Bitcoin-Leute wahrscheinlich immer noch sagen würden, dass Ethereum ein Altcoin ist)'
        },
        {
          Topic: 'ICO',
          Deutsch: 'ICO',
        ...
        },
        {
          ...
          Definition:
            'Der Prozentsatz, wie viel Geld im Vergleich zu einer Erstinvestition verdient wurde. (d.h. 100% ROI bedeutet, dass jemand sein Geld verdoppelt hat).'
        },
        {
          Topic: 'Mining rig',
          Deutsch: '',
          Definition:
            'Ein Computer, der speziell für die Verarbeitung von Proof-of-Work-Blockchains entwickelt wurde. Sie bestehen oft aus mehreren High-End-Grafikprozessoren (GPUs), um ihre Rechenleistung zu maximieren.'
        },
        {
          Topic: 'Sharding',
          Deutsch: '',
        ...
        },
        {
          ...
          Deutsch: 'Zirkulationsversorgung',
          Definition:
        ...
        },
        {
          ...
          Deutsch: '',
          Definition:
            'Der Prozess, bei dem die Blockgröße einer Blockchain erhöht wird, indem digitale Signaturdaten entfernt und an das Ende einer Transaktion verschoben werden, um Kapazitäten freizugeben. Transaktionen werden im Wesentlichen in zwei Segmente unterteilt: das ursprüngliche Datensegment und das Signatursegment (oder Witness).'
        },
        {
          Topic: 'Soft Cap',
          Deutsch: '',
          Definition:
            'Bezieht sich im Allgemeinen auf den Mindestbetrag, den ein Inital Coin Offering (ICO) aufbringen muss. Wenn das ICO diesen Betrag nicht aufbringen kann, kann er annulliert und die gesammelten Gelder an die Teilnehmer zurückgegeben werden.'
        },
        {
          Topic: 'Whitepaper',
          Deutsch: '',
